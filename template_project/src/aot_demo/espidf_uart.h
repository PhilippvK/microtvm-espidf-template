...
#ifndef TVM_APPS_MICROTVM_ESPIDF_AOT_DEMO_ESPIDF_UART_H_
#define TVM_APPS_MICROTVM_ESPIDF_AOT_DEMO_ZEPHYR_UART_H_
...
#endif /* TVM_APPS_MICROTVM_ESPIDF_AOT_DEMO__ESPIDF_UART_H_ */
